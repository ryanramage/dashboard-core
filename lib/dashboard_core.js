...
var dashboard_ddoc_name = 'dashboard';
...
exports.getInstalledApps = function (callback) {
    $.couch.db(dashboard_db_name).view(dashboard_ddoc_name + '/by_active_install', {
        include_docs : true,
...
exports.getInstalledAppsByMarket = function(callback) {
    $.couch.db(dashboard_db_name).view(dashboard_ddoc_name + '/app_version_by_market', {
        success: function(response) {
...
exports.getMarkets = function(callback) {
    $.couch.db(dashboard_db_name).view(dashboard_ddoc_name + '/by_markets', {
        include_docs: true,
        success : function(response) {
            var data = {};
...
exports.updateApp = function(appName, callback) {
    $.couch.db(dashboard_db_name).openDoc(appName, {
